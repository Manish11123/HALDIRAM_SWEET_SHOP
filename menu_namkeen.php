...
<h1 class="text-warning font-monospace text-center my-4"> NAMKEEN </h1>
  ...
  <div class='card-body'>
	...
	<br> &nbsp;
	<a href='paymet.php'>
	<input type='submit' name='submit' class = 'btn btn-success text-white w-100' value='Buy Now'>
	</a>
