...
<h1 class="text-warning font-monospace text-center my-4"> SWEETS</h1>
    ...
    <?php
	 ...
	 <div class='col-md-6 col-lg-4 m-auto mb-3'>
	  ...
	  <form action = 'insertcart' method='POST' id='buy'>
  ...
  <div class='card-body'>
	...
	<a href='paymet.php' onclick='myfunction()'>
